...
///
/// // Generated by macro:
/// // let counterNotifierProvider: NotifierProvider<CounterNotifier, Int>
/// ```
///
...
///     override func build() -> Int { 0 }
///
///     func increment() { update { min($0 + 1, maxValue) } }
///     func decrement() { update { max($0 - 1, minValue) } }
/// }
///
/// let counterProvider = NotifierProvider { BoundedCounterNotifier() }
/// ```
