...
This file is the single entry point for all documentation.
...
To keep naming consistent without breaking existing links, use these canonical labels when referencing docs in discussions/PRs:

- `CORE_GUIDE` -> `core/README.md`
- `MACRO_GUIDE` -> `macros/README.md`
- `RELEASE_GUIDE` -> `release/README.md`
- `ENGINEERING_GUIDE` -> `engineering/README.md`
